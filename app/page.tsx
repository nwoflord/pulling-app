...
function LoginContent() {
  ...
  // CLEANUP ON LOAD: 
  // If the user visits the login page, tell the server to clear any old junk cookies immediately.
  useEffect(() => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success && data.role) {
        // Server set the cookie. We just need to go there.
        ...
        // HARD RELOAD: Forces the browser to re-read the new cookie
